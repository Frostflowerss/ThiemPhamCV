      ...
      <div className="flex items-end justify-between gap-3">
        <div className="min-w-0">
          ...
          <div className="mt-0.5 text-xs">
            <span className="text-white/65">{levelVI}</span>{" "}
            <span className="text-[color:var(--accent)]/90">{levelEN}</span>
          </div>
        </div>
        <div className="text-xs tabular-nums text-[color:var(--accent)]">{value}%</div>
      </div>
